...
from settings import LOCAL_CHROME_DRIVER, BING_LOCAL_IMAGE_STORAGE_PATH
...
class BingCrawler:
    ...
    def run(self, keyword, numberOfImages):
        ...
        output_directory = BING_LOCAL_IMAGE_STORAGE_PATH
        records = [{'aspect_ratio': None,
                    'chromedriver': LOCAL_CHROME_DRIVER,
                    'color': None,
                    'color_type': None,
                    'delay': None,
                    'download': True,
